...
import { UserUpdateOneRequiredWithoutWalletAccountsNestedInputSchema } from './UserUpdateOneRequiredWithoutWalletAccountsNestedInputSchema';
...
export default UserWalletAccountUpdateWithoutTransactionsInputSchema;
